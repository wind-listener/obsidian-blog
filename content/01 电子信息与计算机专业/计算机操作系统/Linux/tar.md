...
### 🧩 主要选项和功能
tar 的选项繁多，但其核心功能围绕**创建**、**查看**、**提取**和**管理**归档文件。
...
| 压缩格式 | 后缀 | 对应参数 | 特点 | 适用场景 |
| :--- | :--- | :--- | :--- | :--- |
| **gzip** | `.tar.gz`, `.tgz` | `-z` | 压缩速度较快，压缩率中等 | 日常使用，平衡速度与压缩率 |
| **bzip2** | `.tar.bz2` | `-j` | 压缩率较高，速度较慢 | 对压缩率要求较高时 |
| **xz** | `.tar.xz` | `-J` | 压缩率最高，速度最慢 | 需要极致压缩，不介意时间 |
| **无压缩** | `.tar` | 无 | 速度最快，仅打包 | 快速归档或后续处理 |
